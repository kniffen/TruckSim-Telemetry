declare module "trucksim-telemetry" {
  export default function truckSimTelemetry(): telemetry;
  ...
  export interface telemetry {
    ...
    getData(key?: string): TelemetryData;
    getBuffer(): any;
    ...
    getTruck(): Truck;
    stop(): void;
    watch(options?: { interval: number }, callback?: (data: TelemetryData) => void): void;
  }
