...
const { uint64le, int64le } = require('./derivitives.js')
...
function getDataFromPluginVersion11(buffer) {
  const entries = _.struct([
    ...
    _.uint8("truck.lights.hazard.enabled"),
    ...
    _.uint8("truck.differential.lock.enabled"),
    _.uint8("truck.liftAxle.enabled"),
    _.uint8("truck.liftAxle.indicator.enabled"),
    _.uint8("trailer.liftAxle.enabled"),
    _.uint8("trailer.liftAxle.indicator.enabled"),
