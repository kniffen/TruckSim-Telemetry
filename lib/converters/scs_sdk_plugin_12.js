...
function getDataFromPluginVersion11(buffer) {
  const entries = _.struct([
    ...
    int64le("game.multiplayerTimeOffset.value"),
    ...
    time("job.expectedDeliveryTimestamp"),
    ...
    time("events.job.delivered.startedTimestamp"),
    time("events.job.delivered.deliveredTimestamp"),
    ...
    // 5th zone
    bool("truck.wheels.steerable", wheelSize),
    bool("truck.wheels.simulated", wheelSize),
    bool("truck.wheels.powered", wheelSize),
    bool("truck.wheels.liftable", wheelSize),
    
    bool("job.cargo.isLoaded"),
    bool("job.isSpecial"),

    bool("truck.brakes.parking.enabled"),
    bool("truck.brakes.motor.enabled"),
    bool("truck.brakes.airPressure.warning.enabled"),
    bool("truck.brakes.airPressure.emergency.enabled"),
    bool("truck.fuel.warning.enabled"),
    bool("truck.adBlue.warning.enabled"),
    bool("truck.engine.oilPressure.warning.enabled"),
    bool("truck.engine.waterTemperature.warning.enabled"),
    bool("truck.engine.batteryVoltage.warning.enabled"),
    bool("truck.electric.enabled"),
    bool("truck.engine.enabled"),
    bool("truck.wipers.enabled"),

    bool("truck.lights.blinker.left.enabled"),
    bool("truck.lights.blinker.right.enabled"),
    bool("truck.lights.blinker.left.active"),
    bool("truck.lights.blinker.right.active"),
    bool("truck.lights.parking.enabled"),
    bool("truck.lights.beamLow.enabled"),
    bool("truck.lights.beamHigh.enabled"),
    bool("truck.lights.beacon.enabled"),
    bool("truck.lights.brake.enabled"),
    bool("truck.lights.reverse.enabled"),
    bool("truck.lights.hazard.enabled"),

    bool("truck.cruiseControl.enabled"),

    bool("truck.wheels.onGround", wheelSize),

    bool("truck.transmission.selector", 2),

    bool("truck.differential.lock.enabled"),
    bool("truck.liftAxle.enabled"),
    bool("truck.liftAxle.indicator.enabled"),
    bool("trailer.liftAxle.enabled"),
    bool("trailer.liftAxle.indicator.enabled"),

    bool("events.job.delivered.autoParked"),
    bool("events.job.started.autoLoaded"),
    ...
    // 12th zone
    bool("events.job.started.active"),
    bool("events.job.finished.active"),
    bool("events.job.cancelled.active"),
    bool("events.job.delivered.active"),
    bool("events.fine.active"),
    bool("events.tollgate.active"),
    bool("events.ferry.active"),
    bool("events.train.active"),
    bool("events.refuel.active"),
    bool("events.refuelPaid.active"),
    ...
    // 14th zone
    _.struct("trailers", [
      bool("wheels.steerable", wheelSize),
      bool("wheels.simulated", wheelSize),
      bool("wheels.powered", wheelSize),
      bool("wheels.liftable", wheelSize),
      bool("wheels.onGround", wheelSize),
...
module.exports = getDataFromPluginVersion11